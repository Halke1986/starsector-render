...
public class Renderer {
    ...
    public record QuadContext(
        ...
        public boolean equals(Object o) {
            ...
            return textureTarget == that.textureTarget && textureID == that.textureID && blendSfactor == that.blendSfactor && blendDfactor == that.blendDfactor && blendEquation == that.blendEquation;
        }
