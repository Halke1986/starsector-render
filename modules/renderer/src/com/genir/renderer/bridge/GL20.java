...
public class GL20 {
    public static void glAttachShader(int program, int shader) {
        ...
        state.exec.execute(new glAttachShader(program, shader));
    }
    ...
    public static void glCompileShader(int shader) {
        ...
        state.exec.execute(new glCompileShader(shader));
    }
    ...
    public static int glCreateProgram() {
        ...
        return state.exec.get(new glCreateProgram());
    }
    ...
    public static int glCreateShader(int type) {
        ...
        return state.exec.get(new glCreateShader(type));
    }
    ...
    public static void glDeleteProgram(int program) {
        ...
        state.exec.execute(new glDeleteProgram(program));
    }
    ...
    public static void glDeleteShader(int shader) {
        ...
        state.exec.execute(new glDeleteShader(shader));
    }
    ...
    public static void glGetAttachedShaders(int program, IntBuffer count, IntBuffer shaders) {
        ...
        state.exec.wait(new glGetAttachedShaders(program, count, shaders));
    }
    ...
    public static void glGetProgramInfoLog(int program, IntBuffer length, ByteBuffer infoLog) {
        ...
        state.exec.wait(new glGetProgramInfoLog(program, length, infoLog));
    }
    ...
    public static String glGetProgramInfoLog(int program, int maxLength) {
        ...
        return state.exec.get(new glGetProgramInfoLog(program, maxLength));
    }
    ...
    public static void glGetShaderInfoLog(int shader, IntBuffer length, ByteBuffer infoLog) {
        ...
        state.exec.wait(new glGetShaderInfoLog(shader, length, infoLog));
    }
    ...
    public static String glGetShaderInfoLog(int shader, int maxLength) {
        ...
        return state.exec.get(new glGetShaderInfoLog(shader, maxLength));
    }
    ...
    public static int glGetShaderi(int shader, int pname) {
        ...
        return state.exec.get(new glGetShaderi(shader, pname));
    }

    public static int glGetUniformLocation(int program, CharSequence name) {
        return state.shaderTracker.glGetUniformLocation(program, name);
    }

    public static int glGetProgrami(int program, int pname) {
        return state.shaderTracker.glGetProgrami(program, pname);
    }
    ...
    public static void glLinkProgram(int program) {
        ...
        state.shaderTracker.glLinkProgram(program);
        state.exec.execute(new glLinkProgram(program));
    }
    ...
    public static void glShaderSource(int shader, CharSequence string) {
        ...
        state.exec.execute(new glShaderSource(shader, string));
    }
    ...
    public static void glUniform1f(int location, float v0) {
        ...
        state.exec.execute(new glUniform1f(location, v0));
    }
    ...
    public static void glUniform1i(int location, int v0) {
        ...
        state.exec.execute(new glUniform1i(location, v0));
    }
    ...
    public static void glUniform1(int location, FloatBuffer values) {
        ...
        state.exec.execute(new glUniform1(location, snapshot));
    }
    ...
    public static void glUniform2f(int location, float v0, float v1) {
        ...
        state.exec.execute(new glUniform2f(location, v0, v1));
    }
    ...
    public static void glUniform2i(int location, int v0, int v1) {
        ...
        state.exec.execute(new glUniform2i(location, v0, v1));
    }
    ...
    public static void glUniform2(int location, FloatBuffer values) {
        ...
        final FloatBuffer snapshot = BufferUtil.snapshot(values);
        state.exec.execute(new glUniform2(location, snapshot));
    }
    ...
    public static void glUniform3f(int location, float v0, float v1, float v2) {
        ...
        state.exec.execute(new glUniform3f(location, v0, v1, v2));
    }
    ...
    public static void glUniform3i(int location, int v0, int v1, int v2) {
        ...
        state.exec.execute(new glUniform3i(location, v0, v1, v2));
    }
    ...
    public static void glUniform3(int location, FloatBuffer values) {
        ...
        final FloatBuffer snapshot = BufferUtil.snapshot(values);
        state.exec.execute(new glUniform3(location, snapshot));
    }
    ...
    public static void glUniform4f(int location, float v0, float v1, float v2, float v3) {
        ...
        state.exec.execute(new glUniform4f(location, v0, v1, v2, v3));
    }
    ...
    public static void glUniform4i(int location, int v0, int v1, int v2, int v3) {
        ...
        state.exec.execute(new glUniform4i(location, v0, v1, v2, v3));
    }
    ...
    public static void glUniform4(int location, FloatBuffer values) {
        ...
        final FloatBuffer snapshot = BufferUtil.snapshot(values);
        state.exec.execute(new glUniform4(location, snapshot));
    }
        ...
        record glUseProgram(int program) implements Runnable {
            ...
            public void run() {
                if (program != 0) {
                    ...
                    state.transformManager.setGPUModelView();
                }

                org.lwjgl.opengl.GL20.glUseProgram(program);

                if (program == 0) {
                    state.transformManager.setCPUModelView();
                }
            }
        }
        state.exec.execute(new glUseProgram(program));
    }
    ...
    public static void glValidateProgram(int program) {
        ...
        state.exec.execute(new glValidateProgram(program));
    }
    ...
    public static void glDetachShader(int program, int shader) {
        ...
        state.exec.execute(new glDetachShader(program, shader));
    }
    ...
    public static void glDisableVertexAttribArray(int index) {
        ...
        state.exec.execute(new glDisableVertexAttribArray(index));
    }
    ...
    public static void glEnableVertexAttribArray(int index) {
        ...
        state.exec.execute(new glEnableVertexAttribArray(index));
    }
    ...
    public static void glUniformMatrix4(int location, boolean transpose, FloatBuffer matrices) {
        ...
        state.exec.execute(new glUniformMatrix4(location, transpose, snapshot));
    }
    ...
    public static void glUniformMatrix3(int location, boolean transpose, FloatBuffer matrices) {
        ...
        final FloatBuffer snapshot = BufferUtil.snapshot(matrices);
        state.exec.execute(new glUniformMatrix3(location, transpose, snapshot));
    }
    ...
    public static void glVertexAttribPointer(int index, int size, int type, boolean normalized, int stride, long buffer_buffer_offset) {
        ...
        state.exec.execute(new glVertexAttribPointer(index, size, type, normalized, stride, buffer_buffer_offset));
    }
    ...
    public static void glDrawBuffers(IntBuffer buffers) {
        ...
        state.exec.execute(new glDrawBuffers(snapshot));
    }
