...
public class ObfTransformations {
    public static List<ClassConstantTransformer.Transform> transformations = Arrays.asList(
            ...
            newTransform("proxy/com/fs/util/FileLoader$ResourceLocationType", "com/fs/util/C$o"),
            newTransform("proxy/com/fs/util/FileLoader$ResourceLocation", "com/fs/util/C$Oo"),
            newTransform("proxy/com/fs/util/FileLoader", "com/fs/util/C"),
            ...
            newTransform("FileLoader_loadInputStreams", "new"),
            newTransform("FileLoader_loadInputStream", "Ó00000"),
            ...
            newTransform("TextureHandler_setColor1", "o00000"),
            newTransform("TextureHandler_setColor0", "Object"),
            newTransform("TextureHandler_setColor2", "Ò00000"),
