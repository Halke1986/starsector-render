...
public class ProgressBar {
     ...
     * ADDED FIELDS
     */
    private static Object currentBar;
    ...
    private void storeBackground() {
        if (textureID == 0) {
            ...
            textureID = com.genir.renderer.bridge.opengl.GL11.glGenTextures();
        } else {
            // Free the texture from previous loading bar for reuse.
            com.genir.renderer.bridge.opengl.GL11.glDeleteTextures(textureID);
        }
        ...
        com.genir.renderer.bridge.opengl.GL11.glCopyTexImage2D(GL11.GL_TEXTURE_2D, 0, GL11.GL_RGBA, 0, 0, width, height, 0);
    ...
    private void drawBackground() {
        ...
        com.genir.renderer.bridge.opengl.GL11.glViewport(0, 0, width, height);
        ...
        com.genir.renderer.bridge.opengl.GL11.glOrtho(0, width, 0, height, -1, 1);
        ...
        com.genir.renderer.bridge.opengl.GL11.glVertex2f(width, 0f);
        com.genir.renderer.bridge.opengl.GL11.glTexCoord2f(1f, 1f);
        com.genir.renderer.bridge.opengl.GL11.glVertex2f(width, height);
        com.genir.renderer.bridge.opengl.GL11.glTexCoord2f(0f, 1f);
        com.genir.renderer.bridge.opengl.GL11.glVertex2f(0f, height);
